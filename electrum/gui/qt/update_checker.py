...
class UpdateCheck(QWidget, PrintError):
    ...
    def __init__(self, main_window, latest_version=None):
        ...
        self.setWindowTitle('Electrum-BDRcoin - ' + _('Update Check'))
    ...
    def update_view(self, latest_version=None):
        if latest_version:
            ...
            if self.is_newer(latest_version):
                ...
                self.detail_label.setText(_("You are already on the latest version of Electrum-BDRcoin."))
        else:
            self.heading_label.setText('<h2>' + _("Checking for updates...") + '</h2>')
            self.detail_label.setText(_("Please wait while Electrum-BDRcoin checks for available updates."))
