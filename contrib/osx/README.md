...
This guide explains how to build Electrum-BDRcoin binaries for macOS systems.
...
#### 1.2 Build Electrum-BDRcoin

    cd electrum-bdrcoin
    ./contrib/osx/make_osx
    
This creates both a folder named Electrum_BDRcoin.app and the .dmg file.
...
Copy the Electrum-BDRcoin.app directory over and install the dependencies, e.g.:
...
Then you can just invoke `package.sh` with the path to the app:
    ...
    cd electrum-bdrcoin
    ./contrib/osx/package.sh ~/Electrum_BDRcoin.app/
