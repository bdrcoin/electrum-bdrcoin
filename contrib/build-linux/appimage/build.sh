...
APPDIR="$BUILDDIR/electrum-bdrcoin.AppDir"
...
APPIMAGE="$DISTDIR/electrum-bdrcoin-$VERSION-x86_64.AppImage"
...
info "preparing electrum-bdrcoin-locale."
(
...
cp "$PROJECT_ROOT/electrum-bdrcoin.desktop" "$APPDIR/electrum-bdrcoin.desktop"
