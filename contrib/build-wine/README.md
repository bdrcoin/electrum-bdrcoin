...
These scripts can be used for cross-compilation of Windows Electrum-BDRcoin executables from Linux/Wine.
...
[that script](https://github.com/bdrcoin/electrum-bdrcoin/blob/master/.travis.yml) might help.
